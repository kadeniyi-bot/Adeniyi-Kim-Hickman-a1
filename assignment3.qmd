...
**Answer**
The most common words are Park (n = 74), Hyde (n = 69), and Chicago (n = 35). From the graph, at least one of the words Hyde, Park, or Chicago appears in all three locations. For the differences, the word south was only present in Hyde Park, was was only present in Kenwood, and homes and housing were only present in the Oakland graph.
